...
3. Use **Edit details** for the asset, reference cutoff, thesis, risks, method, dated sources, and manual review record. Use **Edit full packet** for the four horizon scenarios or exact JSON inspection.
